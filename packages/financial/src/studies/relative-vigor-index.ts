...
> {
   ...
   *  Relative *Volatility* Index, which is a different study and now ships as
   *  {@link relativeVolatilityIndex}; it takes `relVol` as its default output
   *  precisely so the two can coexist on one series. */
  prefix?: Prefix;
}
