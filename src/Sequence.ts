...
import type { TemporalLike, TimestampInput, TimeRangeInput, IntervalInput } from "./temporal.js";
...
function toTimeRange(value: TemporalLike): TimeRange {
  ...
  if (typeof value === "object" && value !== null && "begin" in value && "end" in value) {
...
export class Sequence {
   ...
   */
  static every(every: DurationInput, options: { anchor?: TimestampInput } = {}): Sequence {
