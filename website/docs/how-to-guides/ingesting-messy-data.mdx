...
- [**Ingest**](../pond-ts/transforms/ingest) — the JSON ingest reference: `fromJSON` shapes, parse options, and the `null` ↔
  `undefined` boundary.
- [**API reference (core)**](pathname:///generated-api/core/) — generated full-width reference for every method and type used here.
