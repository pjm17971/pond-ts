...
[Live transforms → Synchronised partitioned rolling](../../pond-ts/live/live-transforms#synchronised-partitioned-rolling).
...
- **Live rolling and aggregation operators** —
  [Live transforms → Trigger-based emission](../../pond-ts/live/live-transforms#trigger-based-emission)
